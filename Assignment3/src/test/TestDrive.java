...
//		experimentOne();
	...
	*/
	...
	/**
	* Compare the whole execution time of PairingHeap and DaryHeap.
	* The execution time includes the time of enqueue, dequeue.
	*/
	static void PairingHeap_vs_DaryHeap(int batch_size, double rate) {
		EfficiencyTest efficiencyTest2 = new EfficiencyTest();
